...
// ------------------------------------------------------------------------
set_include_path(get_include_path() . PATH_SEPARATOR . MODEL_PATH.'PHPLinq/');
require_once(MODEL_PATH.'PHPLinq/LinqToObjects.php');
...
class PS_Pagination {
	...
	function PS_Pagination($connection, $rows_per_page = 3, $links_per_page = 3) {
	 ...
	 * @return string
	 */
	function renderLast($tag = 'Zadnja') {
		if ($this->total_rows == 0)
			return FALSE;
