<div id="adminpanel">
	...
	<div id="adminpanelNaslov"><span>Administracija O nama sekcije</span><span id="opisAdmin">Uredujte O nama sekciju vašim klijentima</span></div>	

<div id="kombinacijaList" class="itemList">
<table width="631" border="0">
<form method="post" enctype="multipart/form-data"> 
<input type="hidden" value="editonama" name="editonama"/>
<tr>
