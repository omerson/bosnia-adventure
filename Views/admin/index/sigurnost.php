<div id="adminpanel">
	...
	<div id="adminpanelNaslov"><span>Administracija sigurnosne poruke</span><span id="opisAdmin">Uredujte sigurnosnu poruku vasim klijentima</span></div>	

<div id="kombinacijaList" class="itemList">
<table width="631" border="0">
<form method="post" enctype="multipart/form-data"> 
<input type="hidden" value="editsigurnost" name="editsigurnost"/>
	<tr>
