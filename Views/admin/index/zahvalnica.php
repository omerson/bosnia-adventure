<div id="adminpanel">
	...
	<div id="adminpanelNaslov"><span>Administracija poruke zahvalnosti</span><span id="opisAdmin">Uredujte poruku zahvalnosti vasim klijentima</span></div>	

<div id="kombinacijaList" class="itemList">
<table width="631" border="0">
<form method="post" enctype="multipart/form-data"> 
<input type="hidden" value="editzahvalnica" name="editzahvalnica"/>
<tr>
