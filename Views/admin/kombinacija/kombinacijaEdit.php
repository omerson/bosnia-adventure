<div id="adminpanel">
	...
	<div id="adminpanelNaslov"><span>Unošenje novih kombinacija</span><span id="opisAdmin">Popunite polja i unesite avanturu na stranicu</span></div>

<div class="unosForme">
<form method="post" name="kombinacija" enctype="multipart/form-data">
<input type="hidden" value="editkombinacija" name="editkombinacija"/>
<input type="hidden" value="<?php echo $row['Id']; ?>" name="kombinacijaId"/>
