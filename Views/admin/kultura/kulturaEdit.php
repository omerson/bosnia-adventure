<div id="adminpanel">
	...
	<div id="adminpanelNaslov"><span>Unošenje novih kultura</span><span id="opisAdmin">Popunite polja i unesite avanturu na stranicu</span></div>

<div class="unosForme">
<form method="post" name="kultura" enctype="multipart/form-data">
<input type="hidden" value="editkultura" name="editkultura"/>
<input type="hidden" value="<?php echo $row['Id']; ?>" name="kulturaId"/>
