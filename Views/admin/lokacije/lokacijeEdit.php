...
<input type="hidden" value="editlokacije" name="editlokacije"/>
<input type="hidden" value="<?php echo $row['Id']; ?>" name="lokacijeId"/>
<table width="806" height="593" border="0">
  <tr>
    <td width="160"  height="50">Naslov</td>
    <td width="636"><input type="text" name="naslov" value="<?php echo $row['Naziv']; ?>" size="60" /></td>
  </tr>
  <tr>
